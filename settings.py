...
ADMINS = (
    # ('Florian Moga', 'moga.flo@gmail.com'),
)
...
SECRET_KEY = '#ac2d8unate8_%!dmqg)4@d0o!p8r=zflntcn-ba+kvx3-8_sr'
...
AUTHENTICATION_BACKENDS = (
  'events.googlebackend.GoogleProfileBackend',
